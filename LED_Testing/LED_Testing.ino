...
void setBoardColor(int board, int red, int green, int blue) //RGB
{
  ...
  if (board == 9)  {aw2.digitalWrite(B9PR, red);  aw2.digitalWrite(B9PG, green);  aw2.digitalWrite(B9PB, blue);  } 
  if (board == 10) {aw2.digitalWrite(B10PR, red); aw2.digitalWrite(B10PG, green); aw2.digitalWrite(B10PB, blue); }
